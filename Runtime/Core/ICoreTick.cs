...
namespace GGTick
{
    ...
    public interface ICoreTick : ICoreSystem
    {
        ...
        /// The render tick.
        /// </summary>
        ITickInstance<ITickRenderClient> renderTick { get; }
        
        /// <summary>
        /// List of fixed (simulation) ticks
        /// </summary>
        TickSimulation[] simulationTicks { get; }
        ...
        /// <summary>
        /// Registers a client to a late render tickset.
        /// </summary>
        /// <param name="obj">The client being registered.</param>
        /// <param name="tickset">The tickset to which to register the client.</param>
        void Register(ITickLateRenderClient obj, TicksetConfigData tickset = null);
        ...
        /// <summary>
        /// Unregisters a client from a late render tickset.
        /// </summary>
        /// <param name="obj">The client being unregistered.</param>
        /// <param name="tickset">The tickset from which to unregister the client.</param>
        void Unregister(ITickLateRenderClient obj, TicksetConfigData tickset = null);
